...
% ruiyuan, 2018-02-10, updated segmentation 
  ...
  %  ConfigFile = ConfigFile(1:end-2);
    ...
    SPGR_folder        = 'anatomical/orig_T2';
...
%==========================================================================
    ...
    output_dir = fullfile(project_dir, 'data/imaging/participants', subject,['visit',visit],['session',session], 'anatomical/orig_T2');
