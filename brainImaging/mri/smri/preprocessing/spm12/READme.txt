...
Run SPM12 based preprocessing of MRI data


Features:

1. Includes three skullstrip options paralist.skullstrip: 0 "SPM-based skullstrip"; 1 "Watershed freesurfer-based skullstrip"
