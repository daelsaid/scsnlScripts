...
function Contrast_Generator(ConfigFile)
%% Begin Program
...
spmscript_path   = ['/oak/stanford/groups/menon/scsnlscripts/brainImaging/mri/fmri/contrastGenerator/' spm_version];

sprintf('adding SPM path: %s\n', spm_path);
addpath(genpath(spm_path));
sprintf('adding SPM based contrast generator scripts path: %s\n', spmscript_path);
