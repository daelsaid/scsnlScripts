...
pipelinefamily = {'swar', 'swavr', 'swgcar', 'swgcavr', 'swgtcar'...
...
%               fclose(fid);
      ...
      %%%%%%---------------------------------------------------   
          ...
          fprintf('>>>> SPGRfile_file is : %s \n',SPGRfile_file);
          auto_reorient(WholePipeLine, CurrentDir, OutputDir,inputimg_file,SPGRfile_FILE);
          %auto_reorient(WholePipeLine, CurrentDir, OutputDir,functional_images,SPGRfile_FILE)
