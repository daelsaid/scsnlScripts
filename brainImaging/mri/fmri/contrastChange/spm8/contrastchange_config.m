...
paralist.stats_server = '/$OAK/projects/2018_Short_Intervention/results/taskfmri/participants';

% Please specify the subject list file
%paralist.subject_list = '11-05-29.1_3T2';
paralist.subject_list = '/$OAK/projects/2018_Short_Intervention/data/subjectlist/pilot_test.csv';
...
paralist.template_path    = '/$OAK/deprecatedGems/scsnlscripts_2018_02_20/spm/BatchTemplates';
