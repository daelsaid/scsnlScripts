...
% Ignore white space if there is any
    ...
    project_dir        = strtrim(paralist.project_dir);
...
for iSubj = 1:length(Subjects)	
  ...
  for i = 1:length(Sessions)
    StatsDir = fullfile(project_dir,'results/taskfmri/participants/', PID, ['visit',VISIT], ['session',SESSION],'glm', 'stats_spm12', Sessions{i});
