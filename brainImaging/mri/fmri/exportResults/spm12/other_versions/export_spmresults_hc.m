function export_spmresults_hc (Config_File)
%
...
%- HC 11/16/18: added SPM toolbox path and modified get_xspm.m function 
...
for i = 1:nstats
  ...
  for iconst = 1:ncontrast
    ...
    [TabData xSPM] = get_xspm_hc(spm_file, contrast_index(iconst), ...
      threshold_info, mask_file, NumMax, DisMax); %HC modified 'get_xspm_hc.m' function in /oak/stanford/groups/menon/scsnlscripts/brainImaging/mri/fmri/utilities/ 
