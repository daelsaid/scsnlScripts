...
function pmod_design(subject_i,ConfigFile)
...
for subcnt = 1:numsub
	...
	for irun = 1:numrun
	    ...
	    addpath(pmod_filepath)

	    [sess_name names onsets durations pmod rest_exists] = pmod(sess_name names onsets durations pmod rest_exists)
