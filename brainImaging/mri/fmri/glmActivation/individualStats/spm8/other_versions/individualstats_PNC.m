...
%---yuan added to use explicit mask----
matlabbatch{1}.spm.stats.fmri_spec.mask{1} = '/oak/stanford/groups/menon/scsnlscripts/brainImaging/mri/fmri/masks/whole_brain_mask.nii';
