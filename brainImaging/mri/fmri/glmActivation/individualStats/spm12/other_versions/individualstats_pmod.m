...
%           diary off; 
      ...
      save task_design.mat sess_name names onsets durations pmod rest_exists reg_file reg_names reg_vec
    end
    ...
    clear sess_name names onsets durations pmod rest_exists reg_file reg_names reg_vec
  end
