function SPM=PPPI_mask_rui(parameterstructure,structfile)
...
if ~strcmp(spm('Ver'),'SPM12')
    ...
    disp('  You must use SPM12 or SPM8  to process your data; however, you can use SPM.mat files')
...
if P.Estimate==1
  fprintf('start spm_estimate_PPI_mask \n');
   try
      if isempty(P.maskdir)
         SPM=spm_estimate_PPI_mask(P.subject,'SPM.mat',P.Region,P.method,P.analysis,P.CompContrasts);
      else
          SPM=spm_estimate_PPI_mask(P.subject,'SPM.mat',P.Region,P.method,P.analysis,P.CompContrasts,P.maskdir);
      end  
   catch
