function SPM=PPPI_rui(parameterstructure,structfile)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if ~strcmp(spm('Ver'),'SPM12')&& ~strncmpi(spm('Ver'), 'SPM12',5)
    disp('PROGRAM ABORTED:')
    disp('  You must use SPM12 to process your data; however, you can use SPM.mat files')
    ...
    disp(' ')
    disp('Make sure to add SPM12 to your MATLAB path before re-running.')
    return
end
