...
%-Subject list
paralist.subjectlist = '/oak/stanford/groups/menon/projects/daa/2015_ACx_parcellation_HCP/data/subjectlist/Orig_Sample_n123/test_2subs.csv';
%-Run list
paralist.runlist = '/oak/stanford/groups/menon/projects/daa/2015_ACx_parcellation_HCP/scripts/restfmri/seedfc/Individ_Stats/runlist.txt';
...
paralist.roi_dir = '/oak/stanford/groups/menon/projects/daa/2015_ACx_parcellation_HCP/data/imaging/roi';

% Please specify the ROI list (full file name with extensions)
paralist.roi_list = '/oak/stanford/groups/menon/projects/daa/2015_ACx_parcellation_HCP/data/imaging/roi/ROI_List_17_Bilateral_STC_Seeds_Add_Left_SPT_yz.txt';
