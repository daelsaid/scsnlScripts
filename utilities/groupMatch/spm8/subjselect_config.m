...
paralist.projectdir = '/oak/stanford/groups/menon/scsnlscripts/utilities/groupMatch/'
...
paralist.subjectlist = '/oak/stanford/groups/menon/scsnlscripts/utilities/groupMatch/spm8/all_subjectslist.csv';

% Please specify the path for the output comma separated subject list file.
% The output subjects will be saveed in this file.
paralist.selectedsubjectlist = '/oak/stanford/groups/menon/scsnlscripts/utilities/groupMatch/spm8/selected_subjectslist.csv';

% Please specify the desired number of subjects that are to be selected
paralist.numberofselectedsubjects = 10;
...
paralist.var_mean = [0 21/4 9.87 113.6];
...
paralist.var_std = [0 0 1.62 17.33];
